...
@section('content')
    <div class="row mb-3">
        <div class="col-sm-6">
            <h1>Tambah Data Laporan Gangguan</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Beranda</a></li>
                <li class="breadcrumb-item"><a href="{{ route('opd-laporangangguan.index') }}">Data Laporan Gangguan</a></li>
                <li class="breadcrumb-item active">Tambah Data Laporan Gangguan</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('opd-laporangangguan.store') }}"
                      method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        <select name="jaringan_id"
                                            ...
                                            @foreach ($jaringans as $data)
                                                <option value="{{ $data->id ?? '' }}"
                                                        {{ old('jaringan_id') == $data->id ? 'selected' : '' }}>
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('jam', \Carbon\Carbon::now()->format('H:i:s')) }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="prioritas"
                                            ...
                                            <option value="Rendah"
                                                    {{ old('prioritas') == 'Rendah' ? 'selected' : '' }}>Rendah</option>
                                            <option value="Sedang"
                                                    {{ old('prioritas') == 'Sedang' ? 'selected' : '' }}>Sedang</option>
                                            <option value="Tinggi"
                                                    {{ old('prioritas') == 'Tinggi' ? 'selected' : '' }}>Tinggi</option>
                                        </select>
                                        @error('prioritas')
                                            <div class="invalid-feedback">
                                                {{ $message }}
