...
<head>
    ...
    <style>
        ...
        .instansi { font-size: 18px; font-weight: bold; }
        .dinas { font-size: 22px; font-weight: bold; }
        .alamat { font-size: 11px; }

        .garis-1 { border-top: 3px solid #000; margin-top: 6px; }
        .garis-2 { border-top: 1px solid #000; margin-top: 2px; }
        ...
        table.tindak th, table.tindak td {
...
<table class="detail">
    ...
    <tr>
        ...
        <td class="separator">:</td>
        <td>{{ \Carbon\Carbon::parse($laporans->waktu_kejadian)->format('d-m-Y H:i') }}</td>
    </tr>
</table>
...
<table class="tindak">
    ...
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="5" align="center"><i>Belum ada tindak lanjut</i></td>
            </tr>
        @endforelse
    </tbody>
</table>
