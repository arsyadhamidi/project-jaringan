...
@section('content')
    <div class="row mb-3">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Tambah Data Status</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('admin-status.store') }}"
                      method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="nm_status"
                                            ...
                                            <option value="Baru"
                                                    {{ old('nm_status') == 'Baru' ? 'selected' : '' }}>Baru</option>
                                            <option value="Diproses"
                                                    {{ old('nm_status') == 'Diproses' ? 'selected' : '' }}>Diproses</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="warna"
                                            ...
                                            <option value="1"
                                                    {{ old('warna') == '1' ? 'selected' : '' }}>
                                                Biru
                                            </option>
                                            <option value="2"
                                                    {{ old('warna') == '2' ? 'selected' : '' }}>
                                                Kuning
                                            </option>
                                            <option value="3"
                                                    {{ old('warna') == '3' ? 'selected' : '' }}>
                                                Hijau
                                            </option>
                                            <option value="0"
                                                    {{ old('warna') == '0' ? 'selected' : '' }}>
                                                Merah
                                            </option>
                                        </select>
                                        @error('warna')
