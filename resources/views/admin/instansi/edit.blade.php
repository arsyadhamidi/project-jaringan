...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('admin-instansi.update', $instansis->id ?? '-') }}"
                      method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('nm_instansi', $instansis->nm_instansi ?? '-') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email"
                                               ...
                                               value="{{ old('email', $instansis->email ?? '-') }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alamat"
                                                  ...
                                                  placeholder="Masukan alamat" rows="5">{{ old('alamat', $instansis->alamat ?? '-') }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
