...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('admin-jaringan.update', $jaringans->id ?? '') }}"
                      method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        <select name="instansi_id"
                                            ...
                                            @foreach ($instansis as $data)
                                                <option value="{{ $data->id ?? '-' }}"
                                                        {{ old('instansi_id', $jaringans->instansi_id) == $data->id ? 'selected' : '' }}>{{ $data->nm_instansi ?? '-' }}</option>
                                            @endforeach
                                        </select>
                                        @error('instansi_id')
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('jns_jaringan', $jaringans->jns_jaringan ?? '-') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('ip_address', $jaringans->ip_address ?? '-') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('bandwidth', $jaringans->bandwidth ?? '-') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="status"
                                            ...
                                            <option value="Normal"
                                                    {{ old('status', $jaringans->status) == 'Normal' ? 'selected' : '' }}>Normal</option>
                                            <option value="Bermasalah"
                                                    {{ old('status', $jaringans->status) == 'Bermasalah' ? 'selected' : '' }}>Bermasalah</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="keterangan"
                                                  ...
                                                  rows="5"
                                                  placeholder="Masukan keterangan">{{ old('keterangan', $jaringans->keterangan ?? '-') }}</textarea>
                                        @error('keterangan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
