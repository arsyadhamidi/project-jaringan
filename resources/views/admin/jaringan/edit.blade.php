                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('tipe_jaringan', $jaringans->tipe_jaringan ?? '-') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="status"
                                            ...
                                            <option value="Online"
                                                    {{ old('status', $jaringans->status) == 'Online' ? 'selected' : '' }}>Online</option>
                                            <option value="Offline"
                                                    {{ old('status', $jaringans->status) == 'Offline' ? 'selected' : '' }}>Offline</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">
                                                {{ $message }}
